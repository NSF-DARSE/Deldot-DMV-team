...
def main() -> None:
    ...
    parser.add_argument(
        "--features",
        type=Path,
        default=OUTPUTS / "model_features_v1" / "t0_compact_features.csv",
    )
    parser.add_argument(
        "--labels",
        type=Path,
    ...
    parser.add_argument("--config", type=Path, default=CONFIGS / "t0_model_v1.json")
    parser.add_argument(
        "--output-dir", type=Path, default=OUTPUTS / "t0_model_v1"
    )
